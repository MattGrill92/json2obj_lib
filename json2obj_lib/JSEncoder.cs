...
namespace json2obj_console_test
{
    public class JSEncoder
    {
        ...
        private string EncodeString(JSString obj, int depth = 0) => str_replace('"', '\\"', $"{new string('\t', depth)}\"{obj.Key}\": \"{obj.Value}\"");
...
//NK
        ...
        private string EncodeStringNK(JSStringNK obj, int depth = 0) => str_replace('"', '\\"', $"{new string('\t', depth)}\"{obj.Value}\"");
